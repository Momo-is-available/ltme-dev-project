			...
			<div
				...
				<div className="p-6">
					...
					<button
						...
						className="w-full flex items-center justify-center gap-3 p-3 bg-white hover:bg-gray-50 border border-gray-200 rounded-lg transition-all duration-200 hover:border-gray-300 hover:shadow-sm mb-3">
